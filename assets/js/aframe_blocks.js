Blockly.defineBlocksWithJsonArray([
        ...
        args0: [
            {
                ...
                options: [
                    ...
                    [{src: "assets/markers/letterH.png", width: 30, height: 30}, 'assets/patterns/letterH.patt'],
    ...
    },
    {
        ...
        message0:"Set Button %1 on click to Actions %2",
        args0:[
            {    // Beginning of the field variable dropdown
                "type": "field_variable",
                "name": "VAR",    // Static name of the field
    ...
    {
        type:"a-box",
        message0:"a-box color %1 depth %2 height %3 width %4 component %5",
        args0:[
            {
                "type": "field_colour",
                "name": "COLOUR",
    ...
    {
        type:"a-gltf-model",
        message0:"a-gltf-model id %1 src %2 component %3",
        args0:[
            {    // Beginning of the field variable dropdown
                "type": "field_variable",
                "name": "VAR",    // Static name of the field
    ...
    {
        type:"a-obj-model",
        message0:"a-obj-model id %1 src %2 mtl %3 component %4",
        args0:[
            {    // Beginning of the field variable dropdown
                "type": "field_variable",
                "name": "VAR",    // Static name of the field
    ...
    {
        type:"a-sky",
        message0:"a-sky src %1 color %2 component %3",
        args0:[
            {
                type: "input_value",
                name: "SOURCE",
    ...
    {
        type:"a-camera",
        message0:"a-camera far %1 fov %2 near %3 component %4",
        args0:[
            {
                "type": "field_number",
                "name": "FAR",
    ...
    {
        type:"a-cursor",
        message0:"a-cursor far %1 fuse %2 fuse-timeout %3 inteval %4 object %5 component %6",
        args0:[
            {
                "type": "field_number",
                "name": "FAR",
    ...
    {
        type:"a-circle",
        message0:"a-circle color %1 src %2 radius %3 component %4",
        args0:[
            {
                "type": "field_colour",
                "name": "COLOUR",
    ...
    {
        type:"a-cone",
        message0:"a-cone color %1 src %2 radius-bottom %3 radius-top %4 component %5",
        args0:[
            {
                "type": "field_colour",
                "name": "COLOUR",
